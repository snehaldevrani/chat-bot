...
# Stage 2 human-in-the-loop administrator settings.
...
ADMIN_SECRET_TOKEN = os.getenv("ADMIN_SECRET_TOKEN", "stage3-dev-admin-token")

# Stage 3 MCP persistence settings.
MCP_SERVER_PORT = int(os.getenv("MCP_SERVER_PORT", "8001"))
MCP_SERVER_URL = os.getenv("MCP_SERVER_URL", "http://127.0.0.1:8001")
MCP_SECRET_TOKEN = os.getenv("MCP_SECRET_TOKEN", "stage3-dev-mcp-token")
